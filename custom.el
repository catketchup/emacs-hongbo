...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (isend-mode julia-mode ebib ein diminish modern-cpp-font-lock flycheck-cython flycheck cython-mode helm-gtags company-irony-c-headers company-c-headers company-irony irony smooth-scroll smooth-scrolling pretty-hydra symbol-overlay doom-themes doom-modeline company-box elpy magit beacon undo-tree smartparens yasnippet-snippets iedit org-roam org-sidebar cdlatex auctex pdf-view-restore bongo olivetti nov youdao-dictionary shell-pop vterm xterm-color pdf-tools py-yapf projectile linum-off company-prescient swiper magic-latex-buffer live-py-mode hy-mode company use-package helm)))
...
(custom-set-faces
 ...
 '(lazy-highlight ((t (:background "deep sky blue" :foreground "black"))))
 '(pdf-isearch-batch ((t nil)))
 '(pdf-isearch-lazy ((t (:background "deep sky blue" :height 1.0))))
 '(pdf-isearch-match ((t (:background "magenta")))))
